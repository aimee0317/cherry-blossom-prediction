...
# Results & Discussion
Our best performing model Categorical Boosting (CatBoost) achieved a $R^2$ of $0.974$, a negative RMSE of $-3.75$ and a MAPE of $3.135$ on the test data. We applied the predicted weather and CO2 emission data to the model and predicted the future peak cherry blossom dates as shown in Table 1. 
